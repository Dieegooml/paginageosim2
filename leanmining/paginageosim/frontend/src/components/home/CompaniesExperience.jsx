...
const CompanyLogo = ({ company, index }) => {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="bg-white/80 backdrop-blur-sm border border-slate-200/60 rounded-2xl px-6 py-5 flex items-center justify-center h-24 transition-all duration-300 hover:shadow-lg hover:shadow-primary-500/10 hover:border-primary-200">
        {!imageError ? (
          <img
            src={company.logo}
...
const CompaniesExperience = () => {
  ...
  return (
    <section ref={sectionRef} className="py-20 md:py-28 bg-gradient-to-b from-slate-50 to-white relative overflow-hidden">
      {/* Decorative elements */}
        ...
        >
          ...
          >
            <p className="text-slate-500 text-sm">
              Más de <span className="font-semibold text-primary-600">80 años</span> de experiencia combinada en operaciones mineras de clase mundial
            </p>
          </motion.div>
        </motion.div>
      </Container>
