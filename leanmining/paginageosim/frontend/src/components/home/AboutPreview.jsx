...
const AboutPreview = () => {
  ...
  const highlights = [
    {
      label: t('aboutPreview.highlights.0'),
      icon: (
    ...
    {
      label: t('aboutPreview.highlights.1'),
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      label: t('aboutPreview.highlights.2'),
      icon: (
        <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
