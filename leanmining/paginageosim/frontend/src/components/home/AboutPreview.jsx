...
const highlights = [
  {
    label: '+200 años de experiencia combinada',
    icon: (
          ...
          >
            ...
            >
              <Button
                to="/nosotros"
                size="large"
                className="group bg-slate-900 text-white hover:bg-primary-600 border-0 px-9 py-4 text-sm font-semibold uppercase tracking-wider rounded-xl shadow-lg shadow-slate-900/15 hover:shadow-xl hover:shadow-primary-600/20 hover:scale-[1.02] transition-all duration-300"
              >
                Conócenos
                <svg className="w-4 h-4 ml-3 transform group-hover:translate-x-1 transition-transform duration-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
