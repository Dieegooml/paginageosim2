...
const expertiseAreas = [
  ...
  },
  {
    ...
    description: 'Análisis de procesos de concentración de minerales, evaluación de desempeño de planta, optimización de recuperación metalúrgica, identificación de cuellos de botella operativos y auditorías técnicas de procesos.',
    subtitle: 'Especialistas en metalurgia y optimización de plantas concentradoras',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Hidrogeología Aplicada a Operaciones Mineras',
    description: 'Estudios hidrogeológicos para minería, gestión de aguas subterráneas, dewatering mina subterránea y cielo abierto, modelamiento hidrogeológico, balance hídrico y sostenibilidad.',
    icon: (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const ExpertiseAreas = () => {
  ...
  const cardClassName =
    'h-full min-h-[28rem] rounded-2xl border border-slate-200/80 bg-white/90 p-6 md:p-8 shadow-sm transition-all duration-500 ease-out hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200/60 flex flex-col justify-between';
  ...
  return (
    <section className="relative py-16">
      <Container>
            ...
            >
              <div className={cardClassName}>
                <div className="flex flex-col gap-4">
                  ...
                  <h3 className="text-xl font-semibold text-slate-900 leading-tight min-h-[3.25rem]">
                    {area.title}
                  </h3>
                ...
                {area.subtitle && (
                  <p className="mt-4 pt-4 text-sm font-medium text-slate-500 border-t border-slate-200">
                    {area.subtitle}
                  </p>
                )}
              </div>
        ...
        <div className="mt-8 md:mt-10 max-w-[56rem] mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10">
