...
const ExpertiseAreas = () => {
  ...
  const expertiseAreas = [
    {
      title: t('aboutPage.expertise.area1Title'),
      description: t('aboutPage.expertise.area1Desc'),
      icon: (
    ...
    {
      title: t('aboutPage.expertise.area2Title'),
      description: t('aboutPage.expertise.area2Desc'),
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: t('aboutPage.expertise.area3Title'),
      description: t('aboutPage.expertise.area3Desc'),
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: t('aboutPage.expertise.area4Title'),
      description: t('aboutPage.expertise.area4Desc'),
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      title: t('aboutPage.expertise.area5Title'),
      description: t('aboutPage.expertise.area5Desc'),
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <section className="relative py-16">
      <Container>
        <div className="max-w-4xl mb-10">
          ...
          >
            {t('aboutPage.expertise.titlePart1')}{' '}
