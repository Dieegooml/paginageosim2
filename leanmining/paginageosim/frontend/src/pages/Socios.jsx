...
const partners = [
  {
    ...
    name: 'EboGeotech',
    description:
      'Empresa especializada en geotecnia y servicios de ingeniería aplicada a proyectos de minería e infraestructura. Aporta capacidades técnicas en estabilidad de terrenos, monitoreo geotécnico y soluciones de campo.',
  ...
  },
  {
    ...
    name: 'Zoluzion',
    description:
      'Empresa tecnológica enfocada en soluciones digitales e innovación para el sector minero y empresarial. Desarrolla herramientas que optimizan procesos operativos y facilitan la toma de decisiones basada en datos.',
...
const PartnerCard = ({ partner, index }) => (
  ...
  >
    ...
    <div className="flex items-center justify-center h-36 px-10 border-b border-slate-100 bg-slate-50 group-hover:bg-white transition-colors duration-300">
      ...
      />
      {/* Fallback: company initial badge */}
      <div
        style={{ display: 'none' }}
      ...
      <Container>
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-slate-900 leading-tight mb-5">
            Empresas que impulsan nuestro ecosistema
          </h1>
          <div className="w-12 h-1 bg-primary-500 rounded-full mb-6" />
          <p className="text-lg text-slate-500 leading-relaxed">
            Colaboramos con empresas especializadas que fortalecen nuestras capacidades
            técnicas y tecnológicas, aportando soluciones innovadoras que complementan
